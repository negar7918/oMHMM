...
from oMHMM.tests.simulations.scenario_1 import spamhmm_orthogonal_with_hyperparam_init_B
...
for hyperparam in hyperparameters:
    mhmm = spamhmm_orthogonal_with_hyperparam_init_B.SpaMHMM(hyperparam, epsilon=0, n_nodes=1,
                                                             mix_dim=M,
