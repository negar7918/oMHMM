...
from oMHMM.tests.digits import spamhmm_orthogonal_init_B, spamhmm_init_B
...
mhmm = spamhmm_orthogonal_init_B.SpaMHMM(n_nodes=1, epsilon=0,
                       mix_dim=M,
                       n_components=num_of_states,
                       n_features=seq_len,
                       graph=None,
...
print('MHMM v_measure: {}'.format(np.mean(v_measure)))
