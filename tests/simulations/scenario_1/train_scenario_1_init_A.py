...
from oMHMM.tests.simulations.scenario_1 import spamhmm_orthogonal_with_hyperparam_init_A
...
for hyperparam in hyperparameters:
    mhmm = spamhmm_orthogonal_with_hyperparam_init_A.SpaMHMM(hyperparam=hyperparam, epsilon=0, n_nodes=1,
                                                             mix_dim=M,
...
print('hyperparameter {}'.format(hyperparameters[np.where(v_measures_oMHMM == np.max(v_measures_oMHMM))[0][0]]))
