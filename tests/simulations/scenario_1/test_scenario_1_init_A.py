...
from oMHMM.tests.digits import spamhmm_init_A, spamhmm_orthogonal_init_A, spamhmm_init_B, spamhmm_orthogonal_init_B
...
v_measures = np.append(v_measures, v_measure)
print(transitions.reshape(M, num_of_states, num_of_states))
print(np.exp(pi_nk))

print('MHMM v_measure: {}'.format(v_measures))
print('oMHMM v_measure: {}'.format(v_measures)) # due to lambda = 0
