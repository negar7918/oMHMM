...
from oMHMM.tests.simulations.scenario_2 import spamhmm_orthogonal_3clust_init_C, spamhmm_3clust_init_C
...
mhmm = spamhmm_3clust_init_C.SpaMHMM(n_nodes=1,
                              mix_dim=M,
...
mhmm = spamhmm_orthogonal_3clust_init_C.SpaMHMM(hyperparam=1, epsilon=.0000001, n_nodes=1, mix_dim=M,
                                     n_components=num_of_states,
                                     n_features=seq_len,
                                     graph=None,
                                     n_iter=100,
