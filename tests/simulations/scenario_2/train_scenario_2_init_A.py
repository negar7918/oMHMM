...
from oMHMM.tests.simulations.scenario_2 import spamhmm_orthogonal_3clust_init_A
...
for hyperparam in hyperparameters:
    mhmm = spamhmm_orthogonal_3clust_init_A.SpaMHMM(hyperparam=hyperparam, epsilon=.0000001, n_nodes=1,
                                                             mix_dim=M,
