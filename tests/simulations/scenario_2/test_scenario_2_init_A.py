...
from oMHMM.tests.simulations.scenario_2 import spamhmm_orthogonal_3clust_init_A, spamhmm_3clust_init_A
...
mhmm = spamhmm_3clust_init_A.SpaMHMM(n_nodes=1,
                              mix_dim=M,
...
mhmm = spamhmm_orthogonal_3clust_init_A.SpaMHMM(hyperparam=1, epsilon=.0000001, n_nodes=1, mix_dim=M,
                                     n_components=num_of_states,
                                     n_features=seq_len,
                                     graph=None,
                                     n_iter=100,
